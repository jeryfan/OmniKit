...
const en: Translations = {
  ...
  toolBox: {
    ...
    tools: {
      ...
      qrCodeGenerator: {
        ...
        description: "Generate QR codes from text or URLs with customizable size.",
      },
      httpDebugger: {
        title: "HTTP Debugger",
  ...
  tools: {
    ...
    jsonFormatter: {
      ...
      minify: "Minify",
      compare: "Compare",
      comparePlaceholder: "Paste JSON to compare...",
      copy: "Copy",
    ...
    httpDebugger: {
      title: "HTTP Debugger",
      subtitle: "Send HTTP requests and inspect responses",
      back: "Back",
      urlLabel: "URL",
      methodLabel: "Method",
...
const zh: Translations = {
  ...
  toolBox: {
    ...
    tools: {
      ...
      qrCodeGenerator: {
        title: "二维码生成器",
        description: "将文本或 URL 生成二维码图片，支持自定义大小。",
      },
      httpDebugger: {
        title: "HTTP 调试器",
  ...
  tools: {
    ...
    jsonFormatter: {
      ...
      minify: "压缩",
      compare: "对比",
      comparePlaceholder: "粘贴要对比的 JSON...",
      copy: "复制",
      formatted: "JSON 格式化成功",
